...
2. "분석할 경쟁사 브랜드를 알려주세요. (2~5개 권장)"
3. "경쟁사의 광고나 랜딩페이지 URL 또는 캡처 이미지가 있나요? (있으면 제공, 없으면 '없음')"
4. "어떤 채널의 메시지를 주로 분석할까요? (메타 광고 / 랜딩페이지 / SNS / 전체)"
5. "특히 파악하고 싶은 것은? (소구점 패턴 / 카피 톤앤매너 / 가격 전략 / CTA 방식)"
...
```
output/{name}/research/{YYMMDD}-competitor-scan/
...
→ `docs/lmf-learnings.md` (이전 winner 소구점과 중복 여부 확인)
