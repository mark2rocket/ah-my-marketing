...
2. "릴스의 핵심 메시지 또는 소구점을 알려주세요. (VP 코드 또는 자유 주제)"
3. "영상 길이는 몇 초인가요? (권장: 15초 / 30초 / 60초)"
4. "브랜드 컬러를 알려주세요. (HEX 코드 — 모르면 '기본값 사용')"
5. "배경 음악 분위기는? (없음 / 경쾌 / 감성 / 강렬 — 스크립트 템포 결정용)"
...
```
output/{name}/reels/{YYMMDD}-{소구점코드}/
├── reels.html          — 애니메이션 소스
