...
3. "카드뉴스 주제 또는 핵심 메시지를 알려주세요. (VP 코드 또는 자유 주제)"
4. "슬라이드는 몇 장으로 구성할까요? (권장: 5~10장)"
5. "비율을 선택해주세요. (1:1 정방형 / 4:5 세로형 / 9:16 릴스)"
6. "브랜드 컬러를 알려주세요. (HEX 코드 — 모르면 '기본값 사용'이라고 입력)"
7. "사용할 폰트가 있나요? (없으면 Noto Sans KR 기본 적용)"
...
```
output/{name}/{account}/cardnews/{YYMMDD}-{주제또는VP코드}/
├── storyboard.md
├── html/
│   ├── slide-01.html
│   └── slide-02.html
